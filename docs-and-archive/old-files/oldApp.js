...
import AvailabilityButtons from './src/components/AvailabilityButtons';
import CookieConsent from './src/components/CookieConsent';
import DeleteAccountModal from './src/components/DeleteAccountModal';
import InviteFriendsModal from './src/components/InviteFriendsModal';
import LoginScreen from './src/components/LoginScreen';
import MapView from './src/components/MapView';
import MapboxMapView from './src/components/MapboxMapView';
...
import { getMockDataForOfflineMode } from './src/utils/mockData';
...
function App() {
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      const { AuthService } = await import('./src/services/firebaseService');
                            ...
                            onClick={async () => {
                              try {
                                ...
                                const { getMockDataForOfflineMode } =
                                  await import('./src/utils/mockData');
                                const mockData = getMockDataForOfflineMode();
